...
Скрипт устанавливает и настраивает все описанные выше компоненты на уже установленной Ubuntu 24.04 LTS. Он не устанавливает саму операционную систему и не настраивает роутер.
